<?php
define("DEFAULT_TIMEZONE", "Asia/Makassar"); // set php date functions timezone
...
define("SITE_NAME", "Jurnal Aktivitas Pegawai");
...
define("APP_ID", "67a29bd16a7de3b25682080ef059068e");
...
define("SITE_FAVICON", IMG_DIR . "logo-favi.png");
define("SITE_LOGO", IMG_DIR . "logo-sman8.png");
...
define("DB_USERNAME", "u945146722_jurnalpeg");
define("DB_PASSWORD", "Jurn4l@peg");
define("DB_NAME", "u945146722_jurnalpegawai");
define("DB_TYPE", "mysql");
define("DB_PORT", "");
define("DB_CHARSET", "utf8");

define("MAX_RECORD_COUNT", 40); //Default Max Records to Retrieve  per Page
define("ORDER_TYPE", "DESC");  //Default Order Type

// Active User Profile Details
define('USER_ID',(isset($_SESSION[APP_ID.'user_data']) ? $_SESSION[APP_ID.'user_data']['kodeguru'] : null ));
define('USER_NAME',(isset($_SESSION[APP_ID.'user_data']) ? $_SESSION[APP_ID.'user_data']['kodeguru'] : null ));
