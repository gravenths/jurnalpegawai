                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-namajabatan"  value="<?php  echo $this->set_field_value('namajabatan',""); ?>" type="text" placeholder="Enter Namajabatan"  required="" name="namajabatan"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
