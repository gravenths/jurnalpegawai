...
class AgendaController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				agenda.kodemapel LIKE ? OR 
				agenda.kelas LIKE ? OR 
				agenda.materi LIKE ? OR 
				agenda.jumlahsiswa LIKE ? OR 
				agenda.sakit LIKE ? OR 
				agenda.ijin LIKE ? OR 
				agenda.tidakhadir LIKE ? OR 
			)";
			$search_params = array(
		...
		$page_title = $this->view->page_title = "Jurnal Mengajar";
	...
	function view($rec_id = null, $value = null){
		...
		if($record){
			$page_title = $this->view->page_title = "Lihat Jurnal";
		$this->view->report_filename = date('Y-m-d') . '-' . $page_title;
		$this->view->report_title = $page_title;
		$this->view->report_layout = "report_layout.php";
		$this->view->report_paper_size = "A4";
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("hari","tanggal","waktu","kodeguru","kodemapel","kelas","materi","jumlahsiswa","sakit","ijin","tidakhadir","photo");
			...
			$this->rules_array = array(
				...
				'ijin' => 'required|numeric',
				'tidakhadir' => 'required|numeric',
			);
			$this->sanitize_array = array(
				'hari' => 'sanitize_string',
				'tanggal' => 'sanitize_string',
				'waktu' => 'sanitize_string',
				'kodemapel' => 'sanitize_string',
				'kelas' => 'sanitize_string',
				'materi' => 'sanitize_string',
				'jumlahsiswa' => 'sanitize_string',
				'sakit' => 'sanitize_string',
				'ijin' => 'sanitize_string',
				'tidakhadir' => 'sanitize_string',
			);
		...
		$page_title = $this->view->page_title = "Tambah Jurnal Mengajar";
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("kodeagenda","hari","tanggal","waktu","kodeguru","kodemapel","kelas","materi","jumlahsiswa","sakit","ijin","tidakhadir");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'hari' => 'required',
		...
		$page_title = $this->view->page_title = "Edit  Jurnal";
		if(!$data){
			$this->set_page_error();
		}
