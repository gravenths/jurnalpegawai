...
if(! defined('PNG_IS_TRANSPARENT') ) 	define ('PNG_IS_TRANSPARENT', TRUE);  //42 Define if a png image should have a transparent background color. Use False value if you want to display a custom coloured canvas_colour 
...
class timthumb {
	...
	public function __construct(){
		...
		$this->src = str_ireplace($this->pathUrl(), '', $this->src);
